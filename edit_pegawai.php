...
<div class="uk-form-row">
	<div class="uk-form-icon">
		...
		<input type="text" placeholder="SESUAI DENGAN KTP..." class="uk-form-width-medium"></input>
	</div>
</div>
<div class="uk-form-row">
...
<div class="uk-form-row">
	...
	<hr>
	<button class="uk-button uk-button-primary" type="button"><i class="uk-icon-save"></i> UPDATE</button>
