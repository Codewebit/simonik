...
<div class="uk-container uk-overflow-container uk-container-center">
        <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">
            ...
            <nav class="uk-navbar uk-margin-large-bottom">
                <a class="uk-navbar-brand uk-hidden-small" href="layouts_frontpage.html">SIMONIK V1</a>
                <ul class="uk-navbar-nav uk-hidden-small">
                    <li class="uk-active">
                        <a href="layouts_frontpage.html"><i class="uk-icon-home"></i> Beranda</a>
                    </li>
                    <li>
                        <a href="login32_bkbmonik.php"><i class="uk-icon-sign-in"></i> Masuk Sistem </a>
                    </li>
                </ul>
                 ...
                 <div class="uk-navbar-flip">
                                    <ul class="uk-navbar-nav uk-hidden-small">
                                        <li class="uk-parent" data-uk-dropdown>
                                            <a href=""><i class="uk-icon-book"></i> Masuk E-Learning </a>
                                        </li>
                                    </ul>
                                </div>
            </nav>
                ...
                <div class="uk-width-medium-1-1">
                    ...
                    <div class="uk-vertical-align uk-text-center" style="background: url('data:image/svg+xml;base64,') 50% 0 no-repeat; height: 450px;">
                        <div class="uk-vertical-align-middle uk-width-1-2">
                            <h1 class="uk-heading-large">Sistem Baru Kami</h1>
                            <p class="uk-text-large">Mulailah dengan kemudahan ketika melalukan sebuah pekerjaan, sehingga anda merasa terbantu dengan adanya sistem yang sudah online.</p>
                            <p>
                                <a class="uk-button uk-button-primary uk-button-large" href="#">Pelajari Sekarang</a>
                            </p>
                        </div>
                    </div>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Pengolahan Master Data</h2>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Pengolahan ART Online</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Rekam Konsultasi Pengajar</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Catat Lemburan Anda</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Fitur Rekap Absensi</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-5-6">
                            <h2 class="uk-h3">Rekam Office Pengajar PFT</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                </div>
            ...
            <h1 class="uk-text-center">Nurul Fikri Group</h1>
        ...
        <div id="offcanvas" class="uk-offcanvas">
            <div class="uk-offcanvas-bar">
                <ul class="uk-nav uk-nav-offcanvas">
                    ...
                    <li>
                        <a href="login32_bkbmonik.php">Login</a>
                    </li>
                </ul>
            </div>
        </div>
